...
export default function AdminPressNewPage() {
  ...
  async function handleSave() {
    try {
      ...
      if (!content || content.trim() === "<p>Write press release...</p>") {
      ...
      if (!res.ok) {
        ...
        throw new Error(text || "Failed to create press");
      }
  ...
  return (
    <div className="space-y-8 px-6 min-w-sm pt-8 lg:px-0">
      <h1 className="text-xl font-semibold text-gray-900">New Press Release</h1>
