...
async function getPost(id: string): Promise<PressRelease> {
  const res = await fetch(`${API_BASE}/admin/presses/public/${id}`, {
    cache: "no-store",
  });
...
export default async function PressPostPage({
  ...
  return (
    <main className="mx-auto w-full min-h-screen px-4 pb-8 lg:px-0">
      {post.cover_image_url && (
        <div className="mb-8 mx-auto w-full max-w-6xl overflow-hidden rounded-b-lg">
          <img
